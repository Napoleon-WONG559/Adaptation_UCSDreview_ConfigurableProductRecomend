...
SAMPLED_CSV = "./shuffle_stratified_split/reviews_more_than_40_words_3000_stratified.csv"
REMAINING_CSV = "./shuffle_stratified_split/reviews_more_than_40_words_remaining_samples.csv"
